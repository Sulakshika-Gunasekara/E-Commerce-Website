    ...
    <div id="main-container">
        ...
        <div id="form body">
            <div id="details">
                ...
                <form id="bil-details" action="Account.php" method="POST">
                ...
                <form id="contact-details" action="submit_feedback.php" method="POST">
                    <div class=" form-container">
                        <div>
                ...
                <form id="payment-details" action="Account.php" method="POST">
                    <div class="form-container">
                        <div>
